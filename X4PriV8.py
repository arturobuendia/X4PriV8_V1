#!/usr/bin/env python
# encoding: utf-8
import sys,os,socket, binascii, time, json, random, threading, Queue ,pprint ,urlparse
...
\ \    / /        / ________ \          / /                  / /
 \ \  / /        / /        \ \        / /    MR            / /    MR     
  \ \/ /        / /    MR    \ \       \ \  YASSER          \ \  YASSER   
   \  /        / /   YASSER   \ \       \ \_________         \ \_________    
   \  /       / /      R.Z     \ \       \_________ \         \_________ \                                               
                                              """
...
/_/ \_\  |_| |_|   |_|  |_|   \/   \___/
 ...
 /!\Thanks To Yassine Hd   
                         Thanks To M4rkWalker /!\ """
        for N, line in enumerate(x.split("\n")):
            sys.stdout.write("\x1b[1;%dm%s%s\n" % (random.choice(colors), line, clear))
            time.sleep(0.05)
def zeb():
 print ("""           Welcome BB 
script developped By AmIr OtHmAn (AR0N-TN) 
Before u run all the bots
install this :
          [+] python from this link : https://www.python.org/downloads/
          [+] activePerl from this link : https://www.activestate.com/activeperl/downloads
          [+] Cmder from this link : http://cmder.net/
          [+] NotePad++ from this link : https://notepad-plus-plus.org/download/
Also you need to remove "http://" or "https://" from the websites list
          Thanks For All <3 
Facebook (aron-tn ) : fb.cm/amir.othman.official 
Facebook (Yassine Hd ) : fb.com/yassinehd.official
facebook (M4rkWalker) : fb.com/Officiel.zack
Github : github.com/aron-tn/ """) 
 raw_input("Press Enter To exit .. ")         
def main():
 logo()
 print Fore.CYAN
 print(""" +----------------------+
  + 1) Payload bot v3 (AutoExploit) 
   + 2) Payload bot V2
    + 3) Zone-h cleaner
     + 4) Dorker (XAttacker)
      + 5) BOT v3.7 Wolf Xbrang
       + 6) RxR v2
        + 7) ReadMe Please Before Use THis X4PriV8 Bot <3
         +----------------------+
 """)
 zz=raw_input('=> ')
 if zz=='1':
  ...
  os.system('perl bot.pl ')
 elif zz=='6':
   os.system('rxr2.py')
 elif zz=='7':
  zeb()
 else:
  print ("\nopen your Eyes -______- \n If you want to exit presse \n Ctrl + c \n if you have any idea contact me please <3 \n My account facebook : www.facebook.com/amir.othman.official")
  main()
main()
